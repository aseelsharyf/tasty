...
<template>
    ...
    <DashboardLayout>
        <UDashboardPanel id="roles-edit" :ui="{ body: 'lg:py-12' }">
            <template #header>
                <UDashboardNavbar>
                    <template #leading>
                ...
                <div class="flex flex-col gap-4 sm:gap-6 lg:gap-12 w-full lg:max-w-3xl mx-auto">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <UInput
                                    ...
                                    autocomplete="off"
                                    :disabled="form.processing || isAdminRole"
                                />
                                <template v-if="isAdminRole" #hint>
                                    <span class="text-warning text-xs">Admin role name cannot be changed</span>
                                </template>
                            </UFormField>
                        </UPageCard>
                        ...
                        <UPageCard
                            ...
                            variant="subtle"
                        >
                            <div v-if="isAdminRole" class="mb-4 p-3 bg-warning/10 rounded-lg">
                                <p class="text-sm text-warning">
                                    The Admin role always has all permissions. This cannot be changed.
                                </p>
                            </div>

...
<footer class="mx-auto w-full bg-tasty-blue-black text-tasty-light-gray font-mono" x-data="{ activeAccordion: null }" aria-label="Tasty">
    <div class="mx-auto max-w-[1880px] site-container px-6 pt-20 pb-12">

...
<main class="flex-1">
    <div class="max-w-lg mx-auto px-6 py-12">
        ...
        <div class="mt-8 rounded-xl bg-gray-50 p-4 text-base sm:text-sm">
            <div class="flex items-start gap-3 text-gray-500">
                ...
                <div class="min-w-0 space-y-2">
                    <p class="text-pretty">Your payment is processed securely via SSL encryption. We do not store your card details. All card payments are handled by Bank of Maldives (BML Connect).</p>

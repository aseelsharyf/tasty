...
class MenuSeeder extends Seeder
{
    ...
    private function seedHeaderMenus(): void
    {
        ...
        $this->createMenuItems($headerPrimary, [
            ...
            ["label" => "Feature", "url" => "/category/feature"],
            ["label" => "People", "url" => "/category/people"],
            ["label" => "Review", "url" => "/category/review"],
            ["label" => "Recipe", "url" => "/category/recipe"],
            ["label" => "Pantry", "url" => "/category/pantry"],
        ]);
    ...
    private function seedFooterMenus(): void
    {
        ...
        $this->createMenuItems($footerOffice, [
            ...
            [
                ...
                "page_slug" => "editorial-policy",
            ],
            [
                "label" => "Work With Us",
                "url" => "/work-with-us",
                "page_slug" => "work-with-us",
            ],
            [
                "label" => "Submit a Story",
                "url" => "/submit-story",
                "page_slug" => "submit-story",
            ],
            ["label" => "Archive", "url" => "#"],
        ]);

...
class Feature2Section extends AbstractSectionDefinition
{
    ...
    {
        return 'Feature Curve Plus';
    }

    public function description(): string
    {
        return 'Alternate full-width feature section with header and single post highlight.';
    }

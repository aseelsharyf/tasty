...
class SitemapController extends Controller
{
    ...
    protected function addPosts(SimpleXMLElement $xml): void
    {
        Post::query()
            ->published()
            ->with('categories')
    ...
    protected function addTags(SimpleXMLElement $xml): void
    {
    ...
    protected function addAuthors(SimpleXMLElement $xml): void
    {
        User::query()
    ...
    protected function addPages(SimpleXMLElement $xml): void
    {
        Page::query()
            ->published()
